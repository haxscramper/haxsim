...
proc S*(this: SegDesc_field3): uint8 = this.field1.S
proc `S=`*(this: var SegDesc_field3, value: uint8) = this.field1.S = value
proc DPL*(this: SegDesc_field3): uint8 = this.field1.DPL
proc `DPL=`*(this: var SegDesc_field3, value: uint8) = this.field1.DPL = value
proc P*(this: SegDesc_field3): uint8 = this.field1.P
proc `P=`*(this: var SegDesc_field3, value: uint8) = this.field1.P = value
...
proc S*(this: SegDesc): uint8 = this.field3.field1.S
proc `S=`*(this: var SegDesc, value: uint8) = this.field3.field1.S = value
proc DPL*(this: SegDesc): uint8 = this.field3.field1.DPL
proc `DPL=`*(this: var SegDesc, value: uint8) = this.field3.field1.DPL = value
proc P*(this: SegDesc): uint8 = this.field3.field1.P
proc `P=`*(this: var SegDesc, value: uint8) = this.field3.field1.P = value
...
proc B*(this: TSSDesc_field3): uint8 = this.field0.B
proc `B=`*(this: var TSSDesc_field3, value: uint8) = this.field0.B = value
proc `Type=`*(this: var TSSDesc_field3, value: uint8) = this.field1.Type = value
proc D*(this: TSSDesc_field3): uint8 = this.field1.D
proc `D=`*(this: var TSSDesc_field3, value: uint8) = this.field1.D = value
proc S*(this: TSSDesc_field3): uint8 = this.field1.S
proc `S=`*(this: var TSSDesc_field3, value: uint8) = this.field1.S = value
proc DPL*(this: TSSDesc_field3): uint8 = this.field1.DPL
proc `DPL=`*(this: var TSSDesc_field3, value: uint8) = this.field1.DPL = value
proc P*(this: TSSDesc_field3): uint8 = this.field1.P
proc `P=`*(this: var TSSDesc_field3, value: uint8) = this.field1.P = value
...
proc `S=`*(this: var TSSDesc, value: uint8) = this.field3.field1.S = value
proc DPL*(this: TSSDesc): uint8 = this.field3.field1.DPL
proc `DPL=`*(this: var TSSDesc, value: uint8) = this.field3.field1.DPL = value
proc P*(this: TSSDesc): uint8 = this.field3.field1.P
