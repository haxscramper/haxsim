...
proc initEmulator*(set: EmuSetting): Emulator =
  ...
  with result.accs.io:
    ...
    setPortio(0x040, 4, pit.portio)
    setPortio(0x060, 1, kb.portio)
    setPortio(0x064, 1, kb.portio)
    setPortio(0x0a0, 2, picS.portio)
    setPortio(0x092, 1, syscon.portio)
    setPortio(0x3b4, 2, vga.getCrt().portio)
    setPortio(0x3ba, 1, vga.portio)
    setPortio(0x3c0, 2, vga.getAttr().portio)
    setPortio(0x3c2, 2, vga.portio)
    setPortio(0x3c4, 2, vga.getSeq().portio)
    setPortio(0x3c6, 4, vga.getDac().portio)
    setPortio(0x3cc, 1, vga.portio)
    setPortio(0x3ce, 2, vga.getGc().portio)
    setPortio(0x3d4, 2, vga.getCrt().portio)
    setPortio(0x3da, 1, vga.portio)
    setPortio(0x3f0, 8, result.fdd.portio)
    setPortio(0x3f8, 1, com.portio)
    setMemio(0xa0000, 0x20000, vga.memio)
