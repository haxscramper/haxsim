...
proc imul_r16_rm16*(this: var Instr16): void =
  var rm16_s: int16
  r16_s = this.exec.get_r16()
  rm16_s = this.exec.get_rm16()
  this.exec.set_r16(r16_s * rm16_s)
...
proc movsx_r16_rm8*(this: var Instr16): void =
  var rm8_s: int8
  rm8_s = this.exec.get_rm8()
  this.exec.set_r16(rm8_s)

proc movsx_r16_rm16*(this: var Instr16): void =
  var rm16_s: int16
  rm16_s = this.exec.get_rm16()
  this.exec.set_r16(rm16_s)
...
proc add_rm16_imm8*(this: var Instr16): void =
  var rm16: uint16
  rm16 = this.exec.get_rm16()
  this.exec.set_rm16(rm16 + IMM8)
  discard EFLAGS_UPDATE_ADD(rm16, IMM8)

proc or_rm16_imm8*(this: var Instr16): void =
  var rm16: uint16
  rm16 = this.exec.get_rm16()
  this.exec.set_rm16(rm16 or IMM8)
  discard EFLAGS_UPDATE_OR(rm16, IMM8)
...
proc adc_rm16_imm8*(this: var Instr16): void =
  ...
  rm16 = this.exec.get_rm16()
  cf = EFLAGS_CF
  this.exec.set_rm16(rm16 + IMM8 + cf)
  discard EFLAGS_UPDATE_ADD(rm16, IMM8 + cf)
...
proc sbb_rm16_imm8*(this: var Instr16): void =
  ...
  cf = EFLAGS_CF
  this.exec.set_rm16(rm16 - IMM8 - cf)
  discard EFLAGS_UPDATE_SUB(rm16, IMM8 + cf)

proc and_rm16_imm8*(this: var Instr16): void =
  var rm16: uint16
  rm16 = this.exec.get_rm16()
  this.exec.set_rm16(rm16 and IMM8)
  discard EFLAGS_UPDATE_AND(rm16, IMM8)

proc sub_rm16_imm8*(this: var Instr16): void =
  var rm16: uint16
  rm16 = this.exec.get_rm16()
  this.exec.set_rm16(rm16 - IMM8)
  discard EFLAGS_UPDATE_SUB(rm16, IMM8)

proc xor_rm16_imm8*(this: var Instr16): void =
  var rm16: uint16
  rm16 = this.exec.get_rm16()
  this.exec.set_rm16(rm16 xor IMM8)
...
proc shl_rm16_cl*(this: var Instr16): void =
  ...
  discard EFLAGS_UPDATE_SHL(rm16, cl)
...
proc shr_rm16_cl*(this: var Instr16): void =
  ...
  discard EFLAGS_UPDATE_SHR(rm16, cl)
...
proc sal_rm16_cl*(this: var Instr16): void =
  ...
  rm16_s = this.exec.get_rm16()
  cl = GET_GPREG(CL)
  this.exec.set_rm16(rm16_s shl cl)
...
proc sar_rm16_cl*(this: var Instr16): void =
  ...
  rm16_s = this.exec.get_rm16()
  cl = GET_GPREG(CL)
  this.exec.set_rm16(rm16_s shr cl)
...
proc neg_rm16*(this: var Instr16): void =
  var rm16_s: int16
  rm16_s = this.exec.get_rm16()
  this.exec.set_rm16(-(rm16_s))
  discard EFLAGS_UPDATE_SUB(cast[uint16](0), rm16_s)
...
proc lidt_m24*(this: var Instr16): void =
 ...
 proc initInstr16*(e: ptr Emulator, id: ptr InstrData): Instr16 =
  ...
  set_funcflag(0x05, instr16(add_ax_imm16), CHK_IMM16.uint16)
  ...
  set_funcflag(0x0d, instr16(or_ax_imm16), CHK_IMM16.uint16)
  ...
  set_funcflag(0x68, instr16(push_imm16), CHK_IMM16.uint16)
  set_funcflag(0x69, instr16(imul_r16_rm16_imm16), CHK_MODRM or CHK_IMM16.uint16)
  ...
  block:
    i = 1
    while i < 8:
      set_funcflag(0x90 + i, instr16(xchg_r16_ax), CHK_IMM16.uint16)
      postInc(i)
  set_funcflag(0x98, instr16(cbw), 0)
  set_funcflag(0x99, instr16(cwd), 0)
  set_funcflag(0x9a, instr16(callf_ptr16_16), CHK_PTR16 or CHK_IMM16.uint16)
  ...
  set_funcflag(0xa9, instr16(test_ax_imm16), CHK_IMM16.uint16)

  block:
    i = 0
    while i < 8:
      set_funcflag(0xb8 + i, instr16(mov_r16_imm16), CHK_IMM16.uint16)
      postInc(i)
  set_funcflag(0xc3, instr16(ret), 0)
  set_funcflag(0xc7, instr16(mov_rm16_imm16), CHK_MODRM or CHK_IMM16.uint16)
  ...
  set_funcflag(0xe8, instr16(call_rel16), CHK_IMM16.uint16)
  set_funcflag(0xe9, instr16(jmp_rel16), CHK_IMM16.uint16)
  set_funcflag(0xea, instr16(jmpf_ptr16_16), CHK_PTR16 or CHK_IMM16.uint16)


  set_funcflag(0xed, instr16(in_ax_dx), 0)

  set_funcflag(0xef, instr16(out_dx_ax), 0)
  set_funcflag(0x0f80, instr16(jo_rel16), CHK_IMM16.uint16)
  set_funcflag(0x0f81, instr16(jno_rel16), CHK_IMM16.uint16)
  set_funcflag(0x0f82, instr16(jb_rel16), CHK_IMM16.uint16)
  set_funcflag(0x0f83, instr16(jnb_rel16), CHK_IMM16.uint16)
  set_funcflag(0x0f84, instr16(jz_rel16), CHK_IMM16.uint16)
  set_funcflag(0x0f85, instr16(jnz_rel16), CHK_IMM16.uint16)
  set_funcflag(0x0f86, instr16(jbe_rel16), CHK_IMM16.uint16)
  set_funcflag(0x0f87, instr16(ja_rel16), CHK_IMM16.uint16)
  set_funcflag(0x0f88, instr16(js_rel16), CHK_IMM16.uint16)
  set_funcflag(0x0f89, instr16(jns_rel16), CHK_IMM16.uint16)
  set_funcflag(0x0f8a, instr16(jp_rel16), CHK_IMM16.uint16)
  set_funcflag(0x0f8b, instr16(jnp_rel16), CHK_IMM16.uint16)
  set_funcflag(0x0f8c, instr16(jl_rel16), CHK_IMM16.uint16)
  set_funcflag(0x0f8d, instr16(jnl_rel16), CHK_IMM16.uint16)
  set_funcflag(0x0f8e, instr16(jle_rel16), CHK_IMM16.uint16)
  set_funcflag(0x0f8f, instr16(jnle_rel16), CHK_IMM16.uint16)
  ...
  set_funcflag(0x81, instr16(code_81), CHK_MODRM or CHK_IMM16.uint16)
